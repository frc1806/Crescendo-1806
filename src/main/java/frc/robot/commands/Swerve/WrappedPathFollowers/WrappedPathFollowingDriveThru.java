...
public class WrappedPathFollowingDriveThru extends Command {
  Command mCommand;
  public WrappedPathFollowingDriveThru() {
  ...
  public void initialize() {
    mCommand = RobotContainer.S_SWERVE.getPathFindCommand(RobotContainer.S_VISION.getDriveThruFeeder());
